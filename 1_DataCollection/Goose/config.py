...
DATA_COLLECTED_DIR: str = os.environ.get(
    "GOOSE_DATA_DIR",
    str(common_config.PROJECT_ROOT / "3_DataStorage" / BAND_NAME / "Collected"),
)
DATA_META_DIR: str = os.environ.get(
    "GOOSE_DATA_DIR",
    str(common_config.PROJECT_ROOT / "3_DataStorage" / BAND_NAME / "Meta"),
)
# Band-specific log file path
LOG_DIR_NAME: str = os.environ.get("GOOSE_LOG_DIR_NAME", "logs")
LOG_FILENAME: str = os.environ.get("GOOSE_LOG_FILENAME", "goose_pipeline.log")
# Band-specific log file path, now rooted in the main project logs directory
# common_config.LOG_DIR_NAME is typically 'logs'
# BAND_NAME is 'Goose'
# LOG_FILENAME is 'goose_pipeline.log'
# Resulting path: <PROJECT_ROOT>/logs/Goose/goose_pipeline.log
LOG_FILE_PATH: Path = (
...
SETLIST_DATA_FILENAME: str = os.environ.get(
    "GOOSE_SETLIST_DATA_FILENAME", "setlistdata.csv"
)
TRANSITION_DATA_FILENAME: str = os.environ.get(
    "GOOSE_TRANSITION_DATA_FILENAME", "transitiondata.csv"
)
NEXT_SHOW_FILENAME: str = os.environ.get("GOOSE_NEXT_SHOW_FILENAME", "next_show.json")
LAST_UPDATED_FILENAME: str = os.environ.get(
    "GOOSE_LAST_UPDATED_FILENAME", "last_updated.json"
)
