...
DATA_COLLECTED_DIR: str = os.environ.get('GOOSE_DATA_DIR', str(common_config.PROJECT_ROOT / '3_DataStorage' / BAND_NAME / 'Collected'))
DATA_META_DIR: str = os.environ.get('GOOSE_DATA_DIR', str(common_config.PROJECT_ROOT / '3_DataStorage' / BAND_NAME / 'Meta'))
