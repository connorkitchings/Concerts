...
from formatting import format_next_show_wsp, format_next_show_um, format_next_show_phish_goose
...
def get_next_show_info(band: str, bands_dir: Path) -> Optional[str]:
    ...
    try:
        ...
        if band == "WSP":
            ...
            return format_next_show_phish_goose(data, showdata_path, venuedata_path, date_field="show_date")
        elif band == "Phish":
            showdata_path = band_dir / "PhishNet" / "showdata.csv"
            venuedata_path = band_dir / "PhishNet" / "venuedata.csv"
            return format_next_show_phish_goose(data, showdata_path, venuedata_path, date_field="showdate")
        else:
            return None
